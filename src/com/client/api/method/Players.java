...
//    }
    ...
    public static Object[] getPlayerArray() {
        return Objects.getInstance().getObjectArray(Constants.mainClass, Constants.playerArray, client.getClient(), Constants.playerClass);
    }

    public static Object getMyPlayer() {
        return Objects.getInstance().getObject(Constants.mainClass, Constants.myPlayer, client.getClient(), Constants.playerClass);
    }


    public static Player myPlayer() {
        Object myPlayer = getMyPlayer();
    ...
    public static final Player[] getPlayers(final Filter<Player> filter) {
        ...
        Object[] oPlayers = getPlayerArray();
