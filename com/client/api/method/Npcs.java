...
public class Npcs {
	...
	private static final Comparator<Npc> NEAREST_SORTER = new Comparator<Npc>() {
		...
		@Override
		public int compare(final Npc n1, final Npc n2) {
	...
	public static Object[] getNpcArray() {
		return Objects.getInstance().getObjectArray(Constants.mainClass, Constants.npcArray,
				client.getClient(), Constants.npcClass);
	}
	...
	public static final Npc[] getNpcs(final Filter<Npc> filter) {
		...
		final Object[] oNpcs = getNpcArray();
